...
for (v, e) in nd_rd_pair_files[0:1]:
    ...
    for (t_prev, t_nxt) in delta_ts_ticks[:10]:
...
#==============================================================================
# to make timestamp into a 
#==============================================================================
for v in node_files[0:1]:
    node_df = pd.read_csv(os.path.join(src_fldr, 'node_files', v))
    for i in xrange(len(f)):
        node_df.timestamp[i] = node_df.timestamp[i].replace(' ', 'T')